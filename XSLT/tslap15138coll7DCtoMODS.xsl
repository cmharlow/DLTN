    ...
    <xsl:template match="//oai_dc:dc">
        ...
        <mods xmlns:xlink="http://www.w3.org/1999/xlink" 
            ...
            <relatedItem type='host' displayLabel="Project">
                ...
                <abstract>This unit of the Tennessee Virtual Archive features images of the work and history of the Civilian Conservation Corps in Tennessee.  Created in 1933 by President Franklin Delano Roosevelt to preserve and nurture America’s natural resources, the CCC brought forests back from the brink of destruction, established recreational destinations, and provided work for tens of thousands of young men from the Volunteer state.  Approximately three million American men, including more than 75,000 Tennesseans, enrolled in the program.  The legacy of the CCC, which was dissolved as the country entered World War II, endured in the lives of the men who served in its ranks and in the improvements made to the nation’s physical landscape...</abstract>
                <location>
                    <url>http://cdm15138.contentdm.oclc.org/cdm/landingpage/collection/p15138coll7</url>
                </location>
            </relatedItem>
