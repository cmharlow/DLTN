...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" 
    ...
    <xsl:template match="//oai_dc:dc">
        <mods xmlns:xlink="http://www.w3.org/1999/xlink" 
            ...
            <!-- Creator/Contributor not used in this set -->
            ...
            <physicalDescription>
                ...
                <form>student publications</form>
            ...
            <xsl:apply-templates select="dc:rights" mode="abstract"/> <!-- stray abstract in rights -->
            ...
            <typeOfResource>text</typeOfResource> <!-- typeOfResource -->
            <relatedItem type='host' displayLabel="Project">
                <titleInfo>
                    <title>Sou'wester (The College's Student Newspaper)</title>
                </titleInfo>
                <location>
                    <url>https://dlynx.rhodes.edu/jspui/handle/10267/2657</url>
                </location>
            </relatedItem>
            <recordInfo>
    ...
    <xsl:template match="dc:date"> 
        <xsl:if test="normalize-space(.)!=''">
            <xsl:choose>
                ...
                <xsl:when test="matches(normalize-space(.), '^\d{4}-\d{2}-\d{2}T.')">
    ...
    <xsl:template match="dc:rights">
        <xsl:choose>
            ...
            <xsl:otherwise>
                <xsl:if test="normalize-space(.)!='' and not(contains(normalize-space(lower-case(.)), 'baseball'))">
    ...
    <xsl:template match="dc:rights" mode="abstract">
        <xsl:if test="normalize-space(.)!='' and contains(normalize-space(lower-case(.)), 'baseball')">
    ...
    <xsl:template match="dc:subject">
        <xsl:if test="normalize-space(.)!=''">
            <xsl:choose>
                <xsl:when test="contains(normalize-space(lower-case(.)), 'student publication')">
                    <genre authority="aat" valueURI="http://vocab.getty.edu/aat/300026642">serials (publications)</genre>
                </xsl:when>
                <xsl:when test="contains(normalize-space(lower-case(.)), 'satire')">
                    <genre authority="aat" valueURI="http://vocab.getty.edu/aat/300251297">satires (document genre)</genre>
                </xsl:when>
            </xsl:choose>
        </xsl:if>
    </xsl:template>
