    ...
    <xsl:template match="//oai_dc:dc">
        ...
        <mods xmlns:xlink="http://www.w3.org/1999/xlink" 
            ...
            <relatedItem type='host' displayLabel="Project">
                <titleInfo>
                    <title>Civil War Military Records</title>
                </titleInfo>
                <abstract>The images found in this section have been gathered from various manuscript collections and offer a glimpse at the wide variety of material available at the Tennessee State Library and Archives that may be of interest to those researching Civil War history and genealogy.  These images illustrate the extensive recordkeeping system at work during the Civil War and demonstrate the complex organizational structure needed to handle the massive accumulation of records.  From transportation orders to quartermaster records, these items not only provide insight into the soldiers’ lives, they also illustrate the costs of war and sacrifices that were made from all facets of society on both the Confederate and Federal sides...</abstract>
                <location>
                    <url>http://cdm15138.contentdm.oclc.org/cdm/landingpage/collection/p15138coll9</url>
                </location>
            </relatedItem>
